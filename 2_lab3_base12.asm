...
jedenascie dd 12 ; tu zmieniam w zalezności od base tu jest 11 dla 11:D
mnoznik_A dd 10
mnoznik_B dd 11
mnoznik_C dd 12
wynik dd ?
...
pop ebx
ret
wczytaj_EAX_U2_b12 ENDP

wyswietl_EAX_U2_b12 PROC
pusha
mov esi, 10 ; indeks w tablicy 'znaki'
mov ebx, 12 ; dzielnik równy 11
mov edi,eax
...
popa
ret
wyswietl_EAX_U2_b12 ENDP

_main PROC
call wczytaj_EAX_U2_b12
sub eax,10
call wyswietl_EAX_U2_b12
call _ExitProcess@4
_main ENDP
END
