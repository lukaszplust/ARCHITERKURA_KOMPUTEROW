...
add bx, 321;odleglosc od kolejnej lini do wykonania na skos
...
; kreślona w innym kolorze 1 wiersz wyzej
sub cs:nastepny,word ptr 320
mov bx,cs:nastepny
...
adres_piksela dw 320 * 200 ; bieżący adres piksela
przyrost dw 0
wektor8 dd ?
nastepny dw 320*200
linia ENDP
